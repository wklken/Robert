...
Read `CONTRIBUTING.md`, run the documented verification commands, and sign
commits with `git commit -s`. Robert uses the Developer Certificate of Origin
and does not require a CLA for the first beta.
