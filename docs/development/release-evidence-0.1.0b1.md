...
- Unit and controlled integration tests: `536` passed
- Compileall: passed
...
| Artifact | SHA-256 |
| --- | --- |
| `robert_github_agent-0.1.0b1-py3-none-any.whl` | `6753af4833646034fca94f4e45aa2b153ee048b8ae288e5dea0975c6cc62b24f` |
| `robert_github_agent-0.1.0b1.tar.gz` | `5eb811b591750ec5993981843442ef76dd7956ebe3cc4fcbfab30e1b4345e960` |

This evidence file is excluded from the source distribution so recording the
source-distribution hash does not create a self-referential artifact.
